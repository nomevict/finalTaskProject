...
class Tela_login(object):
    """
    Classe que configura a interface grafica de login.

    Responsavel por configurar a interface grafica da janela de tela login utilizando a biblioteca PyQt5.

    Attributes
    ----------
    cpf_lineEdit : QtWidgets.QLineEdit
        Caixa de texto para o campo CPF.
    senha_lineEdit : QtWidgets.QLineEdit
        Caixa de texto para o campo senha.
    login_Button : QtWidgets.QPushButton
        Botão para efetuar o login.
    nova_conta_Button : QtWidgets.QPushButton
        Botão para criar uma nova conta.
    sair_login_Button : QtWidgets.QPushButton
        Botão para sair do programa.
    label : QtWidgets.QLabel
        Rótulo com o texto "LOGIN".
    ...
    retranslateUi(Login)
        Traduz os textos exibidos na tela de login.
    """

    def setupUi(self, Login):
        """
        Configura a interface grafica da tela de login.

        Este metodo cria e configura os elementos graficos necessarios para a tela de login.
    ...
    def retranslateUi(self, Login):
        ...
        Este metodo traduz os textos dos elementos graficos exibidos na tela de login.

        Parameters
        ----------
        Login : QtWidgets.QWidget
            O objeto da janela principal em que a tela esta sendo exibida.
        """
