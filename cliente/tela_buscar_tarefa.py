...
class Tela_buscar_tarefa(object):
    """
    Classe que configura a interface grafica de buscar a tarefa.

    Responsavel por configurar a interface grafica da janela de buscar das tarefas utilizando a biblioteca PyQt5.
    """
